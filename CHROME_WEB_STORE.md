...
Rellena los textos con límites típicos (~1.000 caracteres). Para **finalidad única** y **justificación de storage** suele usarse **inglés** (listado en inglés); el resto puede seguir en ES si el formulario lo mezcla.

### Una sola finalidad

**English** (paste into *Single purpose* / *finalidad única*):
